...
$(document).ready(function() {
	var html = '<div id="little_tips" class="follow-tips">'+
			'<a class="avatar follow-link"><img class="avatar-image" src="http://7xpcru.com1.z0.glb.clouddn.com/jllk_github_profile.png?imageView2/2/w/76" width="38" height="38" alt=""></a>'+
